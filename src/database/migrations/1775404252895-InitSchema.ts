...
export class InitSchema1775404252895 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_306030d9411d291750fd115857" ON "tokens" ("user_id", "type") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_16a47ec5cba5f23750f5d1f89c" ON "invites" ("email", "company_id", "status") `);
