...
export class CreateAllTables1775302480862 implements MigrationInterface {
    name = 'CreateAllTables1775302480862'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "positions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying(100) NOT NULL, "description" text, "code" character varying(50), "companyId" uuid NOT NULL, "minSalary" numeric(10,2), "maxSalary" numeric(10,2), "gradeLevel" character varying(10), "isActive" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "company_id" uuid NOT NULL, CONSTRAINT "PK_17e4e62ccd5749b289ae3fae6f3" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_67259fe176abfec6648317e9f2" ON "positions" ("companyId") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_d735c77ce01839c108fa8ec160" ON "positions" ("companyId", "title") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_7d5b477d15c01b6b44f1b4e8cc" ON "users" ("positionId") `);
        await queryRunner.query(`CREATE INDEX "IDX_9b9c040d8c37e2a1edebb72fb5" ON "users" ("email", "status") `);
        await queryRunner.query(`CREATE INDEX "IDX_1fdc14382dd4354e66a4e7e648" ON "users" ("companyId", "role") `);
        await queryRunner.query(`CREATE INDEX "IDX_4f5874da435a91b7ae19c19bc4" ON "users" ("companyId", "status") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_712444039e93513628513fa89a" ON "users" ("companyId", "email") `);
        await queryRunner.query(`CREATE TYPE "public"."tokens_type_enum" AS ENUM('activation', 'reset_password', 'magic_link')`);
        await queryRunner.query(`CREATE TABLE "tokens" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "token" character varying(500) NOT NULL, "type" "public"."tokens_type_enum" NOT NULL, "userId" uuid NOT NULL, "expiresAt" TIMESTAMP NOT NULL, "isUsed" boolean NOT NULL DEFAULT false, "usedAt" TIMESTAMP, "usedIp" character varying(45), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "user_id" uuid NOT NULL, CONSTRAINT "UQ_6a8ca5961656d13c16c04079dd3" UNIQUE ("token"), CONSTRAINT "PK_3001e89ada36263dabf1fb6210a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_28c9785f3f1506fb8d1f55e9b8" ON "tokens" ("expiresAt") `);
        await queryRunner.query(`CREATE INDEX "IDX_ea889bd62cc7e8f8c401b4dcd2" ON "tokens" ("userId", "type") `);
        await queryRunner.query(`CREATE INDEX "IDX_6a8ca5961656d13c16c04079dd" ON "tokens" ("token") `);
        await queryRunner.query(`CREATE TYPE "public"."invites_status_enum" AS ENUM('pending', 'accepted', 'expired', 'cancelled')`);
        await queryRunner.query(`CREATE TABLE "invites" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying(255) NOT NULL, "token" uuid NOT NULL, "status" "public"."invites_status_enum" NOT NULL DEFAULT 'pending', "role" character varying(50) NOT NULL, "companyId" uuid NOT NULL, "invitedById" uuid NOT NULL, "departmentId" uuid, "positionId" uuid, "expiresAt" TIMESTAMP NOT NULL, "sentCount" integer NOT NULL DEFAULT '1', "acceptedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "company_id" uuid NOT NULL, "invited_by" uuid NOT NULL, CONSTRAINT "UQ_18a9a6c85f7cc6f42ebef3b3188" UNIQUE ("token"), CONSTRAINT "PK_aa52e96b44a714372f4dd31a0af" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_08583b1882195ae2674f839132" ON "invites" ("email") `);
        await queryRunner.query(`CREATE INDEX "IDX_d812afa3118384965c84ea8406" ON "invites" ("companyId") `);
        await queryRunner.query(`CREATE INDEX "IDX_512a5c477fc936b04516d7a2d5" ON "invites" ("invitedById") `);
        await queryRunner.query(`CREATE INDEX "IDX_27f0490cde5a9d525c592ba963" ON "invites" ("expiresAt") `);
        await queryRunner.query(`CREATE INDEX "IDX_18a9a6c85f7cc6f42ebef3b318" ON "invites" ("token") `);
        await queryRunner.query(`CREATE INDEX "IDX_b3fef16d251d4bc880ccd1d7f1" ON "invites" ("email", "companyId", "status") `);
        await queryRunner.query(`ALTER TABLE "positions" ADD CONSTRAINT "FK_6844c44333df4976bc4db69aec8" FOREIGN KEY ("company_id") REFERENCES "companies"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "departments" ADD CONSTRAINT "FK_541e3d07c93baa9cc42b149a5fb" FOREIGN KEY ("company_id") REFERENCES "companies"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "departments" ADD CONSTRAINT "FK_2d6673ae91cee09bef47d2a5de2" FOREIGN KEY ("parent_department_id") REFERENCES "departments"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "departments" ADD CONSTRAINT "FK_ef8a4fb89ff96bbe98f1798798c" FOREIGN KEY ("manager_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_8e29a9d2f1fa57ebf1a4ce17353" FOREIGN KEY ("position_id") REFERENCES "positions"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_b3fef16d251d4bc880ccd1d7f1"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_512a5c477fc936b04516d7a2d5"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_d812afa3118384965c84ea8406"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_ea889bd62cc7e8f8c401b4dcd2"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_4f5874da435a91b7ae19c19bc4"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_1fdc14382dd4354e66a4e7e648"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_5c2e2da6ef92ee1df279861fbc"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_d8edd5f44c26d7451d7986c523"`);
        await queryRunner.query(`DROP TABLE "departments"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_3dacbb3eb4f095e29372ff8e13"`);
        await queryRunner.query(`DROP TABLE "companies"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_d735c77ce01839c108fa8ec160"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_67259fe176abfec6648317e9f2"`);
