...
export const AuthSwagger = {
  ...
  login: () => applyDecorators(
    ...
    ApiResponse({ status: HttpStatus.OK, description: 'Login successful, refresh token set in cookie', type: AuthSchema.response }),
  ...
  refresh: () => applyDecorators(
    ...
    ApiResponse({ status: HttpStatus.OK, description: 'New access token returned', type: AuthSchema.response }),
