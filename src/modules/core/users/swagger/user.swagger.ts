  ...
  findAll: () =>
    applyDecorators(
      ApiOperation({
        ...
        description:
          'Returns paginated list of users. HR sees all users, regular users see only their own profile.',
      }),
      ApiResponse({
      ...
      ApiQuery({
        ...
        type: String,
        example: 'createdAt',
        description: 'Sort field: firstName, lastName, email, role, createdAt, updatedAt',
      }),
      ApiQuery({
        name: 'sortOrder',
        required: false,
  ...
  delete: () =>
    applyDecorators(
      ...
      ApiResponse({
        ...
        description: 'This endpoint requires hr role or ownership of the resource',
      }),
      ApiResponse({ status: HttpStatus.UNAUTHORIZED, description: 'Unauthorized' }),
    ),
};
