...
export class PositionResponse implements Partial<Position> {
  ...
  @ApiProperty({ example: 'Senior Developer', description: 'Position title', maxLength: 100 })
  title: string;

  @ApiProperty({ example: 'Senior software developer position', description: 'Position description', required: false })
  description: string;
