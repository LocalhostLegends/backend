...
const user_schema_1 = require("./swagger/user.schema");
...
__decorate([
    (0, common_1.Post)(),
    (0, require_role_decorator_1.RequireRole)(user_entity_enums_1.UserRole.HR),
    (0, user_swagger_1.SwaggerCreateUser)(),
...
__decorate([
    (0, common_1.Get)(),
    (0, require_role_decorator_1.RequireRole)(user_entity_enums_1.UserRole.HR),
    (0, user_swagger_1.SwaggerFindAllUsers)(),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, user_swagger_1.SwaggerFindOneUser)(),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, user_swagger_1.SwaggerUpdateUser)(),
    __param(0, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
...
__decorate([
    ...
    (0, require_role_decorator_1.RequireRole)(user_entity_enums_1.UserRole.HR),
    (0, user_swagger_1.SwaggerDeleteUser)(),
    __param(0, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
    __metadata("design:type", Function),
...
exports.UsersController = UsersController = __decorate([
    ...
    (0, swagger_1.ApiExtraModels)(user_schema_1.UserResponse),
