...
__decorate([
    ...
    (0, class_validator_1.IsString)({ message: 'Position title must be a string' }),
    (0, class_validator_1.MinLength)(2, { message: 'Position title must be at least 2 characters long' }),
    (0, class_validator_1.MaxLength)(100, { message: 'Position title must not exceed 100 characters' }),
