...
const user_entity_enums_1 = require("./user.entity.enums");
...
__decorate([
    (0, typeorm_1.Column)({ type: 'enum', enum: user_entity_enums_1.UserRole, default: user_entity_enums_1.UserRole.EMPLOYEE }),
    __metadata("design:type", String)
